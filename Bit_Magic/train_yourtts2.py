...
"""
CURRENT_PATH = os.path.dirname("/content/drive/MyDrive/YourTTS_Training/")
...
OUT_PATH = os.path.dirname("/content/drive/MyDrive/YourTTS_Training/output")

# If you want to do transfer learning and speedup your training you can set here the path to the original YourTTS model
# "/root/.local/share/tts/tts_models--multilingual--multi-dataset--your_tts/model_file.pth"
RESTORE_PATH = None
